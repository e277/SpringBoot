...
import ungu.fileuploading.storage.StorageFileNotFoundException;
...
public class FileUploadTests {
    ...
    public void should404WhenMissingFile() throws Exception {
        ...
        this.mvc.perform(get("/files/tests.txt")).andExpect(status().isNotFound());
    }
}
